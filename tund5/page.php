...
$semesterinfo = "Semester kulgeb vastavalt akadeemilisele kalendrile.";
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	  ...
	  <input type="email" name="emailinput" id="emailinput" ><span></span>
	  <br>
	  <br>
...
?>
	  <br>
	  <input name="passwordinput" id="passwordinput" type="password"><span></span>

	  <br>
	  <input name="submituserdata" type="submit" value="Logi sisse"><span></span>
	</form>
